...
it('renders TodoItem correctly', () => {
  const component = renderer.create(<Provider store={store}><TodoItem key='1' todo={{ todoId: '1', task: 'Complete work', isCompleted: false }} filter={false} sort='recent' /></Provider>)
